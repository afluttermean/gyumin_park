...
<head>
    ...
    <title>Nintendo World 사이트 맵</title>
    ...
    <script>
        function logout_check() {
            ...
            if (rt) {
                location.href = "../login/mylogout_ok.php";
            };
        };
    </script>
    <?php } ?>
...
<body>
    ...
    <main>
        ...
        <div class="formWrap">
            ...
            <div class="sitemap_images">
                <img src="../images/sitemap_graph.png" alt="사이트맵">
                <dl class="main_lineup">
                    <dt><a href="#none">Lineup</a></dt>
                    <dd><a href="./lineup_ns.html">Nintendo Switch</a></dd>
                    <dd><a href="">Nintendo Switch lite</a></dd>
                    <dd><a href="">Nintendo 3DS</a></dd>
                    <dd><a href="">Nintendo Classic mini</a></dd>
                </dl>
                <dl class="main_amiibo ">
                    <dt><a href="#none">Amiibo</a></dt>
                    <dd><a href=" ">아미보 특징</a></dd>
                    <dd><a href=" ">라인업</a></dd>
                    <dd><a href=" ">대응 소프트웨어</a></dd>
                    <dd><a href=" ">세트 상품</a></dd>
                </dl>
                <dl class="main_software">
                    <dt><a href="#none">Software</a></dt>
                    <dd><a href="./sfotware_ns.html">Nintendo Switch 소프트</a></dd>
                    <dd><a href="./sfotware_3ds.html">Nintendo 3DS 소프트</a></dd>
                    <dd><a href="">스마트폰용 소프트</a></dd>
                    <dd><a href="">발매 예정 소프트웨어</a></dd>
                    <dd><a href="">무료 다운로드</a></dd>
                </dl>
                <dl class="main_character">
        ...
        <div class="footer_wrap">
            ...
            <div class="footer_usepolicy">
                <ul>
                    ...
                    <li class="footer_sitemap"><a href="./sitemap.php">Site Map</a></li>
                </ul>
            </div>
