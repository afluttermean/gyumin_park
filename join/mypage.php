...
?>
    ...
    <head>
        ...
        <title><?php echo $s_uname; ?>의 마이페이지 </title>
        ...
        <main>
            ...
            <div class="formWrap">
                ...
                <div class="main_content">
                    <ul>
                        <li class="my_personal"><a href="./members_edit.php">개인정보 관리</a></li>
                        <li class="my_device"><a href="./device.php">디바이스 관리</a></li>
                        <li class="my_payment"><a href="">구매 내역</a></li>
                        <li class="my_as"><a href="">A/S 내역</a></li>
                    </ul>
                </div>
            </div>
